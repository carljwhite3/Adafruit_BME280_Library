...
public:
  ...
  */
  ...
  // constructors
  Adafruit_BME280();
  Adafruit_BME280(Adafruit_I2CDevice_Adapter &adapter);
  Adafruit_BME280(Adafruit_SPIDevice_Adapter &adapter);
...
protected:
  Adafruit_I2CDevice_Adapter *i2c_dev = NULL; ///< Pointer to I2C bus interface
  Adafruit_SPIDevice_Adapter *spi_dev = NULL; ///< Pointer to SPI bus interface
